...
class Channel(models.Model) :
    ...
    def save(self) :
        ...
        # if str(bg) != 'default_background.jpeg' :
        #     bg_w, bg_h = bg.size

        #     if bg_w / 3.2 < bg_h and bg_h * 3.2 > bg_w :
        #         box = (0, (bg_h - bg_w) / 2, bg_w, (bg_h + bg_w) / 2)
        #         bg = bg.crop(box)
        #     else if bg_w / 3.2 > bg_h and bg_h * 3.2 < bg_w :
        ...
        print('image progil', str(im), '=>', self.profil_img.path)
        print('bg image', str(bg), '=>', self.profil_background.path)
