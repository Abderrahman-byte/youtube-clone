...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('n', 'a', 'm', 'e'), name='unique_content_name'),
        ),
        migrations.AddConstraint(
            model_name='video',
            constraint=models.UniqueConstraint(fields=('channel', 'tilte'), name='unique_videos_per_channel'),
        ),
    ]
